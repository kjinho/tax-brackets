...
import Browser
import Html exposing (Html, caption, div, input, table, tbody, td, text, th, tr)
...
update msg _ =
    case msg of
        Change newContent ->
            ( parseInput newContent, Cmd.none )
...
trRow attributes contents =
    case contents of
        ...
        a :: c ->
            tr attributes (th [] [ a ] :: List.map (\x -> x) c)
